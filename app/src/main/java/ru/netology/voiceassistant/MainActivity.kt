...
class MainActivity : AppCompatActivity() {
    ...
    //Wolfram AppId G893E9-5A5PLXJTAQ
    ...
    val VOICE_RECOGNITION_REQUEST_CODE: Int = 666
    ...
    fun initViews() {
        ...
        val voiceInputButton: FloatingActionButton = findViewById(R.id.voice_input)
